...
export default function PayService() {
    const radios = [
        ...
        },
        {
         ...
         {
            name: "Zain Cash",
            description: "A secure and easy digital wallet for transfers and bill payments in Iraq",
            icon: (
            // Replace this with the actual SVG of the Zain Cash logo
            <img
                src="https://images.seeklogo.com/logo-png/51/1/zain-cash-logo-png_seeklogo-519935.png"
                alt="Zain Cash Logo"
                width={44}
                height={44}
            />
                    ...
                    radios.map((item, idx) => (
                        <li key={idx}>
                            <label htmlFor={item.name} className="block relative">
                                ...
                                <div className="w-full flex gap-x-3 items-start p-4 cursor-pointer rounded-lg border bg-[#f3f2f2] shadow-sm ring-[#7b3bfcbf] peer-checked:ring-2 duration-200">
                                ...
                                <div className="absolute top-4 right-4 flex-none flex items-center justify-center w-5 h-5 rounded-full border peer-checked:bg-[#7b3bfcbf]  text-white peer-checked:text-white duration-500">
