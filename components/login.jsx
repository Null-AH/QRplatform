      ...
      <DialogContent className="dark bg-zinc-900 text-white">
        ...
        <form className="space-y-5">
          ...
          <div className="flex justify-between gap-2">
            ...
            <a
              className="text-sm underline hover:no-underline text-zinc-300"
              href="#"
            >
              Forgot password?
            </a>
...
//   const [message, setMessage] = useState("");
//   const [userInfo, setUserInfo] = useState(null);
//   // const {isSyncedWithBackend, setIsSyncedWithBackend} = useAuth();
...
//         await axios.post(`${baseApiUrl}/api/account/sync`);
